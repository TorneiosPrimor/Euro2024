...
let jogadores = [
  ...
  { posicao: 0, bandeira: 'Croácia', nome: 'Nero', gols: 8 },
  { posicao: 0, bandeira: 'Croácia', nome: 'Helton', gols: 5 },
  { posicao: 0, bandeira: 'Croácia', nome: 'Caio', gols: 2 },
  { posicao: 0, bandeira: 'Croácia', nome: 'Orivaldo', gols: 1 },
  { posicao: 0, bandeira: 'Croácia', nome: 'André', gols: 4 },
  ...
  { posicao: 0, bandeira: 'Inglaterra', nome: 'Rogério', gols: 1 },

  { posicao: 0, bandeira: 'Dinamarca', nome: 'João Marcos', gols: 5 },
  { posicao: 0, bandeira: 'Dinamarca', nome: 'Helbert', gols: 5 },
  { posicao: 0, bandeira: 'Dinamarca', nome: 'Marcos', gols: 3 },
  { posicao: 0, bandeira: 'Dinamarca', nome: 'Ayrton', gols: 4 },
